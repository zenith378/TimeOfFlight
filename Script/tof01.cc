...
void tof01()
{
    ...
    Float_t v2_v[1024];
    Float_t v3_v[1024];
    Double_t timeCF1_15_v;
    Double_t timeCF2_15_v;
    Double_t timeCF3_15_v;
    Double_t timeCF1_50_v;
    Double_t timeCF2_50_v;
    Double_t timeCF3_50_v;
    Double_t rise1;
    Double_t rise2;
    Double_t rise3;
    ...
    rec->Branch("timeCF1_15", &timeCF1_15_v, "timeCF1_15/D");
    rec->Branch("timeCF2_15", &timeCF2_15_v, "timeCF2_15/D");
    rec->Branch("timeCF3_15", &timeCF3_15_v, "timeCF3_15/D");
    rec->Branch("timeCF1_50", &timeCF1_50_v,"timeCF1_50/D");
    rec->Branch("timeCF2_50", &timeCF2_50_v,"timeCF2_50/D");
    rec->Branch("timeCF3_50", &timeCF3_50_v,"timeCF3_50/D");
    ...
    {   /*store in time the times from DRS*/
        ...
        timeCF1_15_v = event.GetChannel(0, 0).GetTimeCF(CF);
        timeCF2_15_v = event.GetChannel(0, 1).GetTimeCF(CF);
        timeCF3_15_v = event.GetChannel(0, 2).GetTimeCF(CF);
        timeCF1_50_v = event.GetChannel(0, 0).GetTimeCF(0.5);
        timeCF2_50_v = event.GetChannel(0, 1).GetTimeCF(0.5);
        timeCF3_50_v = event.GetChannel(0, 2).GetTimeCF(0.5);
        ...
        /*
                auto t2_t1_15 = timeCF2_15 - timeCF1_15;
                auto t3_t1_15 = timeCF3_15 - timeCF1_15;
                auto t3_t2_15 = timeCF3_15 - timeCF2_15;

                auto t2_t1_50 = timeCF2_50 - timeCF1_50;
                auto t3_t1_50 = timeCF3_50 - timeCF1_50;
                auto t3_t2_50 = timeCF3_50 - timeCF2_50;
        */
    ...
    auto df=d.Filter("timeCF1_15>0")
             ...
             .Define("x_50","(7.356-6.538-timeCF2_50+timeCF1_15)/(2*0.06414)")
             .Define("x_cor","(7.356-6.538-timeCF2_15+timeCF1_15)/(2*0.06414)");
    df.Snapshot("Events", rootfile);
    outfile->Close();
